...
check('active pill vs sidebar', ratio([74, 118, 180], SIDE), 3);
check('active pill text', ratio([255, 255, 255], [74, 118, 180]), 4.5);
...
for (const v of ['rgb(107, 120, 150)', 'rgb(110, 175, 240)', 'rgb(146, 160, 186)',
                 'rgb(26, 92, 134)', 'rgba(0, 0, 0, 0.4)', 'rgb(74, 118, 180)',
